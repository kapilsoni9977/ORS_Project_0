...
<link rel="shortcut icon"
	href="/ORSProject0/resources/theam_wel/image/fav-icon.png"
	type="image/x-i">
					...
					<div align="center">
						...
						<H2>
							<span class="glyphicon glyphicon-list"></span><b><b>&nbsp;<s:message
										code="role.label.roleList"></s:message>
							</b></b>
						</H2>
						...
						<c:choose>
							...
							<c:otherwise>
								...
								<div>
									...
									<c:choose>
										<c:when
											test="${list.size()==form.pageSize && !((RoleList.size()==form.pageSize*form.pageNo))}">
