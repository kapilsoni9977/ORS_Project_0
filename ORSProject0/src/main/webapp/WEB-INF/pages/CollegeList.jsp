					...
					<div align="center">
						...
						<H2>
							<span class="glyphicon glyphicon-list"></span><b><b>&nbsp;<s:message
										code="college.label.collegeList"></s:message>
							</b></b>
						</H2>
						...
						<div class="container-fluid text-center">
							...
							<div class="form-inline">
								...
								<div class="form-group  text-center">
									<label class="control-label" for="name"> <s:message
											code="label.city" /> :
									</label> <input type="text" class="form-control" name="city" size=15
							...
							<div style="float: left">
								<div class="col-sm-3">
									<a class="btn btn-primary"
										href="<c:url value="/ctl/College"></c:url>"><s:message
						...
						<c:choose>
							...
							<c:otherwise>
											...
											<tr>
												...
												<c:if test="${sessionScope.user.roleId==1 }">
													<th style="text-align: center;"><input type="checkbox"
														id="mainbox" onchange="selectAll(this)">
													<s:message code="label.selectall" /></th>
												</c:if>
										...
										<tbody>
											...
											<c:forEach items="${list}" var="college" varStatus="ct">
												<tr>
													...
													<td align="center">${college.address}</td>
													<td align="center">${college.state}</td>
													<td align="center">${college.city}</td>
													<td align="center">${college.phoneNo}</td>

													<c:if test="${sessionScope.user.roleId==1 }">
														<td style="size: 20%; text-align: center;"><a
															href="${editUrl}${college.id}"> <span
								...
								<div>
									...
									<c:choose>
										<c:when
											test="${list.size()==form.pageSize && !((collegeList.size()==form.pageSize*form.pageNo))}">
